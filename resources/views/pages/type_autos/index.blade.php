...
<div class="row">
    <div class="col-md-4">
        <div class="card mb-4">
            <form action="{{route('type_auto.store')}}" method='POST' type_auto="form" id="form" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="type_auto_id" value="{{$type_auto->id ?? '' }}"/>

                <div class="card-body">
                    <div class="mb-3">
                        <label for="libelle" class="form-label">Libelle</label>
                        <input type="text"name ="libelle" class="form-control {{ $errors->has('libelle') ? 'is-invalid' : ''}}" id="libelle" placeholder="Veuillez saisir le libelle..."  value="{{ $type_auto != null ? $type_auto->libelle : old('libelle') }}" required>
                            ...
                            if(result == 'done'){
                                ...
                                whichtr.fadeOut(2000, function(){
                                 ...
                                 Swal.fire({
                                    position: 'top',
                                    icon: 'success',
                                    title: 'Suppression du type_auto',
                                    text: 'Type Auto supprimé avec succes !',
