...
<div class="row">
    <div class="col-md-4">
        <div class="card mb-4">
            <form action="{{route('role.store')}}" method='POST' role="form" id="form" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text"name ="libelle" class="form-control {{ $errors->has('libelle') ? 'is-invalid' : ''}}" id="libelle" placeholder="Veuillez saisir le libelle..."  value="{{ $role != null ? $role->libelle : old('libelle') }}" required>
        ...
        function actionsFormatter(value, row, index) {
            return `
                    <div class="btn-group" role="group">
                        <a href="{{ route('role.index','')}}/${value}" class="btn btn-outline-dark waves-effect" data-toggle="tooltip" title="Modifier">
                            ...
                            if(result == 'done'){
                                ...
                                whichtr.fadeOut(2000, function(){
                                 ...
                                 Swal.fire({
                                    ...
                                    text: 'Role supprimé avec succes !',
