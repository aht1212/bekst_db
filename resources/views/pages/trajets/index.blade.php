...
<div class="row">
    <div class="col-md-4">
        <div class="card mb-4">
            <form action="{{route('trajet.store')}}" method='POST' trajet="form" id="form" class="form-horizontal" enctype="multipart/form-data">
                @csrf
        ...
        <div class="card card-box">
            <div class="card-body">
                <div id="toolbar" class="btn-group">
                    <a href="{{ route('trajet.index') }}"  class="btn btn-outline-success">
        ...
        function actionsFormatter(value, row, index) {
            return `
                    <div class="btn-group" trajet="group">
                        <a href="{{ route('trajet.index','')}}/${value}" class="btn btn-outline-dark waves-effect" data-toggle="tooltip" title="Modifier">
