...
@section('title1')Liste des billets
@endsection
@section('content')
<div class="row">
    {{-- liste --}}
        ...
        <div class="card card-box">
            <div class="card-body">
                <div id="toolbar" class="btn-group">
                    <a href="{{ route('billet.create_or_update') }}" id="addRow" class="btn btn-outline-success">
                        <i class="fa fa-plus"></i> Nouveau billet
                    </a>
                </div>
...
<script>
        ...
        $('#table-javascript').bootstrapTable({
            ...
            columns: [
                ...
                {
                    field: 'billet_restant',
                    title: "billet Restant",
                    sortable: true,
                    filterControl: "input",
                },
                {
        ...
        function actionsFormatter(value, row, index) {
            return `<form action="{{ route('billet.delete', '')}}/${value}" method="POST">
                    @csrf
                    @method('DELETE')
                    <div class="btn-group" role="group">
                        ...
                        <a href="{{ route('billet.create_or_update')}}/${value}" class="btn btn-outline-dark waves-effect" data-toggle="tooltip" title="Modifier">
                        ...
                        success: function(result) {
                            if(result == 'done'){
                                 Swal.fire({
                                    position: 'top',
                                    icon: 'success',
                                    title: 'Suppression du billet',
                                    text: 'billet supprimé avec succes !',
